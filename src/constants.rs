...
// Player defaults.
pub const PLAYER_DEFAULT_X: Subpixels = Pixels::new(8).as_subpixels();
pub const PLAYER_DEFAULT_Y: Subpixels = Pixels::new(8).as_subpixels();

// Horizontal speed.
pub const TARGET_WALK_SPEED: Subpixels = Pixels::new(2).as_subpixels();
...
pub const JUMP_INITIAL_SPEED: Subpixels = Pixels::new(3).as_subpixels();
pub const JUMP_ACCELERATION: Subpixels = Subpixels::new(4);
pub const JUMP_MAX_GRAVITY: Subpixels = Pixels::new(2).as_subpixels();
pub const FALL_ACCELERATION: Subpixels = Subpixels::new(10);
pub const FALL_MAX_GRAVITY: Subpixels = Pixels::new(3).as_subpixels();

// Wall sliding.
pub const WALL_SLIDE_SPEED: Subpixels = Subpixels::new(8);
pub const WALL_JUMP_HORIZONTAL_SPEED: Subpixels = Pixels::new(3).as_subpixels();
pub const WALL_JUMP_VERTICAL_SPEED: Subpixels = Pixels::new(3).as_subpixels();
...
pub const SPRING_SPEED: Subpixels = Pixels::new(1).as_subpixels(); // How fast the spring itself moves.
